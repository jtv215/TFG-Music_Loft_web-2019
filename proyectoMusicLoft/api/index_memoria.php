...
$app->get('/cancion/:idEstablecimiento', 'authenticate', function ($idEstablecimiento) use ($app,$db) {


	$consulta = "select * from cancion where idLocal = '" . $idEstablecimiento . 
	"' ORDER BY cast(precioTotal as unsigned) DESC  ";
...
//****************get Monedas Usuario*************************// 
//*puntos*///
$app->get('/puntos/:idEstablecimiento', 'authenticate', function ($idEstablecimiento) use ($app, $db) {
